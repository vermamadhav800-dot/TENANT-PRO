  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <StatCard title="This Month's Expenses" value={`${totalMonthlyExpense.toLocaleString()}`} icon={Calendar} color="danger" />
        <StatCard title="Total Expenses" value={`${totalExpense.toLocaleString()}`} icon={BarChart2} color="warning" />
