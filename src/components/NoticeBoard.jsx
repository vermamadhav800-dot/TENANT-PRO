        ...
        <Dialog open={isAddModalOpen} onOpenChange={setIsAddModalOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                This notice will be visible to all tenants on their dashboard.
              </DialogDescription>
            </DialogHeader>
            <form onSubmit={handleAddNotice} className="space-y-4 py-4">
              <div>
              ...
              <div>
                ...
                <Textarea id="message" name="message" placeholder="Provide details about the announcement..." required rows={5}/>
              </div>
              <DialogFooter>
