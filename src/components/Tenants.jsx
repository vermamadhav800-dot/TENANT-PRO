      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4 py-4">
          <div className="grid grid-cols-1 gap-3 text-sm">
            ...
            <div className="flex items-center gap-3 p-2 rounded-md bg-muted/50"><IndianRupee className="w-4 h-4 text-muted-foreground" /><span>Rent: {tenant.rentAmount?.toFixed(2)} / month</span></div>
