...
// This points to the video file in your `public/video/` folder.
            ...
            >
                 ...
                 >
                    ...
                    <div className="relative p-6 text-center text-white z-20 flex flex-col h-full min-h-[500px]">
                        ...
                        <DialogClose asChild>
                           <button className="absolute right-3 top-3 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground z-30 text-white bg-black/30 hover:bg-black/50 h-8 w-8 flex items-center justify-center">
                                <X className="h-5 w-5" />
